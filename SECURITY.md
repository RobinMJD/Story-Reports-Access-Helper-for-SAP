...
If the commit is missing, rejected, interrupted, or ambiguous, no native form submission is released and no retry is attempted. Once committed, later message-channel loss cannot downgrade the record or authorize a duplicate.
