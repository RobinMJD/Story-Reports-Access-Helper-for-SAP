...
Partner Center submission is deliberately manual. GitHub Actions verifies the tagged source, builds the deterministic Edge ZIP, and publishes the immutable GitHub Release assets; it does not upload or submit packages to Microsoft Edge Add-ons.
